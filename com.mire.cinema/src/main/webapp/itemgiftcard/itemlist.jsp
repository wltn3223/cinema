    ...
    <div style="display: flex; justify-content: space-between; align-items: center;" class="container">
        <div class="tab">
            ...
            <div class="tabcontent">
                <div id="tab01">
                    <a href="#"><img src="/img/item01.PNG" width="1200px" height="400px"
                            style="margin-bottom: 120px; margin-left: 70px;"></a>
                    <a href="#">
                    ...
                    <div class="item-container">
                        <c:forEach var="item" items="${itemGiftCards}">
                            <a href="#" onclick="loadItemInfo('${item.itemName}')">
                                <div class="item">
                                    <img src="${item.image}" alt="${item.itemName} 이미지" width="220" height="220">
        ...
        function appendItemGiftCardToDiv(itemGiftCards) {
            ...
            for (var i = 0; i < itemGiftCards.length; i++) {
                ...
                var row = '<div class="item">' +
                    ...
                    '<p class="item-info" style="color: black; font-size: 13px;">' + itemGiftCard.itemSize + '</p>' +
                    '<p class="item-price" style="color: #9d00f7; font-size: 25px; font-weight: 400;">' + formattedPrice + '원</p>' +
                    '</a>' +
                    '<button class="updateButton" onclick="editItem(\'' + itemGiftCard.itemName + '\')">수정/삭제</button>' +
                    '</div>';
                div.append(row);
            }
        }
