    ...
    function appendItemGiftCardToTable(itemGiftCards) {
        ...
        for (var i = 0; i < itemGiftCards.length; i++) {
            ...
            var row = '<div class="item">' +
                ...
                '<p style="color: #9d00f7; font-size: 25px; font-weight: 400;">' + formattedPrice + '원</p>' +
                '</a>' +
                '<button class="btn btn-primary" onclick="editItem(\'' + itemGiftCard.itemName + '\')">수정/삭제</button>' +
                '</div>';
            div.append(row);
        }
    }
